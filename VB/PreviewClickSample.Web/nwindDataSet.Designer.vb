...
Namespace PreviewClickSample.Web
	...
	End Class
End Namespace
Namespace PreviewClickSample.Web.nwindDataSetTableAdapters
	...
	Partial Public Class CategoriesTableAdapter
		...
		Private Sub InitAdapter()
			...
			Me._adapter.UpdateCommand.CommandText = "UPDATE `Categories` SET `CategoryName` = ?, `Description` = ?, `Picture` = ?, `Ic" & "on_17` = ?, `Icon_25` = ? WHERE ((`CategoryID` = ?))"
		...
		Public Overridable Function Delete(ByVal Original_CategoryID As Integer) As Integer
		...
		Public Overridable Function Update(ByVal CategoryName As String, ByVal Description As String, ByVal Picture() As Byte, ByVal Icon_17() As Byte, ByVal Icon_25() As Byte, ByVal Original_CategoryID As Integer) As Integer
			If (CategoryName Is Nothing) Then
				Throw New Global.System.ArgumentNullException("CategoryName")
			Else
